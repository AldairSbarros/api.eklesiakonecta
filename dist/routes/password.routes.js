...
const passwordController = __importStar(require("../controllers/password.controller"));
 ...
 */
router.post("/solicitar-recuperacao", passwordController.solicitarRecuperacao);
/**
 * @swagger
