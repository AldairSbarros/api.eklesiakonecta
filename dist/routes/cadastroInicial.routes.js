...
const cadastroInicial_controller_1 = require("../controllers/cadastroInicial.controller");
...
router.post('/cadastro-inicial', (req, res, next) => {
    Promise.resolve((0, cadastroInicial_controller_1.cadastroInicial)(req, res)).catch(next);
});
exports.default = router;
//# sourceMappingURL=cadastroInicial.routes.js.map