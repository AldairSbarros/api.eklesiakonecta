...
const usuarioPermissaoService = __importStar(require("../services/usuarioPermissao.service"));
...
const get = async (req, res) => {
    try {
        ...
        if (!usuarioPermissao)
            return res.status(404).json({ error: 'Usuário-permissão não encontrado.' });
...
//# sourceMappingURL=usuarioPermissao.controller.js.map