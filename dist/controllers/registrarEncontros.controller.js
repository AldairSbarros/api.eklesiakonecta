...
const service = __importStar(require("../services/registrarEncontros.service"));
...
const listarEncontros = async (req, res) => {
    const schema = req.headers['schema'];
...
//# sourceMappingURL=registrarEncontros.controller.js.map