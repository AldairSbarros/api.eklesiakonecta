...
exports.getResumoFinanceiroMensal = exports.getResumoFinanceiro = void 0;
const prismaDynamic_1 = require("../utils/prismaDynamic");
const getResumoFinanceiro = async (schema, congregacaoId, ano, mes) => {
...
const getResumoFinanceiroMensal = async (schema, congregacaoId, ano) => {
    const prisma = (0, prismaDynamic_1.getPrisma)(schema);
...
exports.getResumoFinanceiroMensal = getResumoFinanceiroMensal;
